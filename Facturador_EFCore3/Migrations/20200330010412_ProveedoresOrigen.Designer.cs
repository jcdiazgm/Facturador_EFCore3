...
namespace Facturador_EFCore3.Migrations
{
    ...
    [Migration("20200330010412_ProveedoresOrigen")]
    partial class ProveedoresOrigen
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facturador_EFCore3.Modelos.Proveedor", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Proveedor");
                });
            ...
            modelBuilder.Entity("Facturador_EFCore3.Modelos.ProveedorExterno", b =>
                {
                    b.HasBaseType("Facturador_EFCore3.Modelos.Proveedor");

                    b.Property<string>("Pais")
                        .HasColumnType("nvarchar(max)");

                    b.HasDiscriminator().HasValue("ProveedorExterno");
                });

            modelBuilder.Entity("Facturador_EFCore3.Modelos.ProveedorInterno", b =>
                {
                    b.HasBaseType("Facturador_EFCore3.Modelos.Proveedor");

                    b.HasDiscriminator().HasValue("ProveedorInterno");
                });
